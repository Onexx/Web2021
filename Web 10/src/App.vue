...
export default {
    ...
    beforeCreate() {
        ...
        this.$root.$on("onRegister", (login, name) => {
            ...
            if (name.length > 32) {
                this.$root.$emit("onRegisterValidationError", "Name couldn't be longer than 32 letters");
                return;
            }
            ...
            if (login.length < 3 || login.length > 16) {
                this.$root.$emit("onRegisterValidationError", "Login length should be between 3 and 16 letters");
                return;
            }
